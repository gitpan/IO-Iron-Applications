...
# ABSTRACT: Increment an item(s) in cache(s).
...
sub opt_spec {
	...
	return (
        ...
        [ 'create-item', 'If item does not exist, create it', { 'default' => 0, }, ],
	);
}
...
sub execute {
    ...
    $parameters{'create_item'} = $opts->{'create_item'};
    my %output;
...
IO::Iron::Applications::IronCache::Command::increment - Increment an item(s) in cache(s).
